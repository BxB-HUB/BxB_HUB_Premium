...
for _, v in pairs(game:GetService("CoreGui"):GetDescendants()) do
    if v:IsA("TextLabel") and string.find(v.Text,"BxB HUB [*] v") then
...
local Config = { WindowName = "BxB HUB [*] v"..temptable.version.." Community", Color = Color3.fromRGB(164, 84, 255), Keybind = Enum.KeyCode.Semicolon}
